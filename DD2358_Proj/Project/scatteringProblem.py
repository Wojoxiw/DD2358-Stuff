...
class Scatt3DProblem():
    ...
    def ComputeSolutions(self, meshData, computeRef = True):
        ...
        #petsc_options={'ksp_type': 'fgmres','ksp_gmres_restart': 1000, 'pc_type': 'ksp', "ksp_ksp_type": 'bcgs', "ksp_ksp_max_it": 100, 'ksp_pc_type': 'bjacobi', 'ksp_sub_pc_type': 'lu', 'ksp_sub_pc_factor_levels': 1, **conv_sets, **self.solver_settings}
        #petsc_options={'ksp_type': 'fgmres','ksp_gmres_restart': 1000, 'pc_type': 'ksp', "ksp_ksp_type": 'bcgs', "ksp_ksp_max_it": 100, "ksp_pc_type": 'sor', **conv_sets, **self.solver_settings} ## best so far
